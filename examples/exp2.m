...
plot(Zcart1(1,:,1),Zcart1(2,:,1),'b:','LineWidth',2,'DisplayName','雷达1量测轨迹');
plot(Zcart1(1,:,2),Zcart1(2,:,2),'r--','LineWidth',2,'DisplayName','雷达2量测轨迹');
plot(Zcart1(1,:,3),Zcart1(2,:,3),'c-.','LineWidth',2,'DisplayName','雷达3量测轨迹');
