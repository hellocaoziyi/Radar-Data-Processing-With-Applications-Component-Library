...
plot(Station.XEhat(1,:,1),Station.XEhat(3,:,1),'Color','#D95319','LineStyle',':','LineWidth',2,'DisplayName','雷达1 估计轨迹');
plot(Station.XEhat(1,:,2),Station.XEhat(3,:,2),'Color','#EDB120','LineStyle','--','LineWidth',2,'DisplayName','雷达2 估计轨迹');
plot(Station.XEhat(1,:,3),Station.XEhat(3,:,3),'Color','#7E2F8E','LineStyle','-.','LineWidth',2,'DisplayName','雷达3 估计轨迹');
