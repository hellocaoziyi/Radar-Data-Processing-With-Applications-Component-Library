...
plot(squeeze(Target.X(1,targetnum,:)),squeeze(Target.X(3,targetnum,:)),'Color','#0072BD','LineWidth',2,'DisplayName','目标运动轨迹');
end
legend();
title('运动轨迹','FontSize',20);
xlabel('x/m','FontSize',20); 
ylabel('y/m','FontSize',20);
exportgraphics(exp1_1,[pathname,'\Multiple Target Tracking\examples\Results\exp1_1.emf'],'Resolution',600);
exportgraphics(exp1_1,[pathname,'\Multiple Target Tracking\examples\Results\exp1_1.jpg'],'Resolution',600);
exp1_1.Visible = 'on';